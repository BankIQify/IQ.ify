...
const Dashboard = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      link: "/subject-progress/non_verbal"
    },
    {
      ...
      link: "/subject-progress/brain_training"
    },
    {
  ...
  return (
    <div className="page-container">
      <div className="text-center mb-8">
        <h1 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-pastel-pink via-pastel-purple to-pastel-blue bg-clip-text text-transparent mb-4 animate-fadeIn">
      ...
      <div className="mt-12 text-center">
        <Link to="/lets-practice">
          <Card className="p-6 bg-gradient-to-r from-pastel-yellow/20 to-pastel-pink/20 border-2 border-pastel-pink hover:shadow-lg transition-all duration-300 transform hover:scale-105">
            <h3 className="text-xl font-bold mb-4">Start Practicing! 🎯</h3>
            <p className="text-gray-600">
              Take a test and improve your skills!
            </p>
          </Card>
        </Link>
      </div>
